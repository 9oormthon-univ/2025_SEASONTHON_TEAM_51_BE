...
import com.mockit.domain.trading.application.PriceService;
...
public class PriceRestController {
    ...
    public BaseResponse<List<TradingResponseDTO.QuoteDto>> getQuotes(
        ...
        List<TradingResponseDTO.QuoteDto> result = priceService.getQuotes(symbolList);
    ...
    public BaseResponse<List<TradingResponseDTO.CandleDto>> getCandles(
        ...
        List<TradingResponseDTO.CandleDto> result = priceService.getCandles(symbol, tf, limit);
        return BaseResponse.onSuccess(SuccessStatus.OK, result);
    }
}
